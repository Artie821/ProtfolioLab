...
$(function() {
  $('#exampleModal').on('show.bs.modal', function(event) {
    ...
    a.href = '/admin/delete/'+n;
  });
});

$(function() {
  $('#adminDelete').on('show.bs.modal', function(event) {
    var button = $(event.relatedTarget) // Button that triggered the modal
    var n = button.data('name')// Extract info from data-* attributes
    var a = document.getElementById('btnname');
    a.href = '/admin/deleteA/'+n;
  });
});

$(function() {
  $('#institutionDelete').on('show.bs.modal', function(event) {
    var button = $(event.relatedTarget) // Button that triggered the modal
    var n = button.data('name')// Extract info from data-* attributes
    var a = document.getElementById('btnname');
    a.href = '/admin/deleteF/'+n;
  });
});

$(function() {
  $('#institutionUnblock').on('show.bs.modal', function(event) {
    var button = $(event.relatedTarget) // Button that triggered the modal
    var n = button.data('name')// Extract info from data-* attributes
    var a = document.getElementById('btnname2');
    a.href = '/admin/deleteF/'+n;
  });
});
