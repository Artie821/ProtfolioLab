...
<header class="header--form-page">
    ...
    <div class="row">
        <div class="container p-3 my-3 border shadow p-1 mb-1 bg-white rounded">
            <h3 style="float:left"> Edytuj użytkownika: </h3>
    ...
    <div class="container p-3 my-3 border shadow p-1 mb-1 bg-white rounded" style="width: 100%">
        <table id="table" class="display table table-striped" style="width:100%">
            ...
            <tr>
                <th>EDYCJA UŻYTKOWNIKA ${user.username}</th>
            </tr>
            </thead>
            <tbody>
            <form:form method="post" modelAttribute="user" action="/admin/edit/">
                ...
                <tr>
                    <td>
                        <form:input path="username" name="username" placeholder="${user.username}" class="form-control"
                                    value="${user.username}"/>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>
                        <form:input path="email" name="email" placeholder="${user.email}" class="form-control"
                                    value="${user.email}"/>
                    </td>
                </tr>
                <tr>
