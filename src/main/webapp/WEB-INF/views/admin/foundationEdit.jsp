...
<header class="header--form-page">
    ...
    <div class="row">
        <div class="container p-3 my-3 border shadow p-1 mb-1 bg-white rounded">
            <h3 style="float:left"> Edytuj fundacji: </h3>
    ...
    <div class="container p-3 my-3 border shadow p-1 mb-1 bg-white rounded" style="width: 100%">
        <table id="table" class="display table table-striped" style="width:100%">
            ...
            <tr>
                <th>EDYCJA FUNDACJI ${fundation.name}</th>
            </tr>
            </thead>
            <tbody>
            <form:form method="post" modelAttribute="fundation" action="/admin/Fedit/">
                <tr>
                    <th>USERNAME:</th>
                </tr>
                <tr>
                    <td>
                        <form:input path="name" name="name" placeholder="${fundation.name}" class="form-control"
                                    value="${fundation.name}"/>
                    </td>
                </tr>
                <tr>
                    <th>EMAIL:</th>
                ...
                <tr>
                    <td>
                        <form:input path="description" name="description" placeholder="${fundation.description}" class="form-control"
                                    value="${fundation.description}"/>
                    </td>
                </tr>
                <tr>
                    <td>
                        <button type="submit" class="btn btn-primary">ZAPISZ</button>
                        <form:hidden path="id" name="id"  value="${fundation.id}" />
                    </td>
                </tr>
            </form:form>
            </tbody>
