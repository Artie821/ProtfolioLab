...
<header class="header--form-page">
    ...
    <div class="row">
        <div class="container p-3 my-3 border shadow p-1 mb-1 bg-white rounded">
            <h3 style="float:left"> Dodaj nowego administratora: </h3>
            ...
            <c:if test="${param.login}">
                ...
                <div class="alert alert-danger alert-dismissable">
                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                    Użytkownik o takim loginie już istnieje w bazie danych, zmiany nie zostały zachowane!
                </div>
            </c:if>
            <c:if test="${param.email}">
                ...
                <div class="alert alert-danger alert-dismissable">
                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                    Taki email już istnieje w bazie danych, zmiany nie zostały zachowane!
                </div>
            </c:if>
        </div>
    </div>
    ...
    <div class="container p-3 my-3 border shadow p-1 mb-1 bg-white rounded" style="width: 100%">
        <table id="table" class="display table table-striped" style="width:100%">
            ...
            <tr>
                <th>DODAWANIE NOWEGO ADMINISTRATORA</th>
            </tr>
            </thead>
            <tbody>
            <form:form method="post" modelAttribute="userEntity" action="/admin/registerA">
                <tr>
                    <th>USERNAME:</th>
                </tr>
                <tr>
